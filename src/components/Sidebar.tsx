...
import { PanelLeft, Plus, FolderPlus, Settings, CreditCard, User, LogOut, MoreVertical, Star, Search, ChevronDown, UserIcon, Sparkles, Trash2, Pencil } from "lucide-react";
