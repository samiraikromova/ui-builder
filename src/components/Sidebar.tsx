import { Plus, Settings, Menu, User } from "lucide-react";
...
const mockChats: Chat[] = [
  ...
  { id: "6", title: "Email sequence planning" },
  { id: "7", title: "Content calendar creation" },
  { id: "8", title: "Brand voice development" },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-border p-3">
        ...
        {!isCollapsed && <span className="text-sm font-medium text-foreground">Gemini</span>}
      </div>
